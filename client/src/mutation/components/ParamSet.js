...
const ParamSet = (({paramSet}) => {
    ...
    const {deleteParamSet, renderParameterSet, isRendering} = useContext(MutationContext)
    ...
    return(
        <Container>
            ...
            <Popover
                ...
                disableRestoreFocus
            >
                <Typography>{`Forward Mutation Rate: ${paramSet.fr} Backward Mutation Rate: ${paramSet.br}`}</Typography>
            </Popover>
        </Container>
    )
})
