...
const ParamSet = (({paramSet}) => {
    ...
    const {deleteParamSet, renderParameterSet, isRendering} = useContext(SelectionContext)
    ...
    return(
        <Container>
            ...
            <Popover
                ...
                disableRestoreFocus
            >
                <Typography>{`Dominance Coefficient: ${paramSet.h} Selection Coefficient: ${paramSet.s}`}</Typography>
            </Popover>
        </Container>
    )
})
